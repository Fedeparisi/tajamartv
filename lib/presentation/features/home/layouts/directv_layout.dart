...
class DirectvLayout extends ConsumerStatefulWidget {
  const DirectvLayout({super.key});

  @override
  ConsumerState<DirectvLayout> createState() => _DirectvLayoutState();
}

class _DirectvLayoutState extends ConsumerState<DirectvLayout> {
    ...
    return Scaffold(
      ...
      body: channelsAsync.when(
        ...
        data: (channels) {
          ...
          return Column(
            children: [
              // Fixed Hero Preview Section (Always at top)
              Container(
                ...
                child: Stack(
                  children: [
                    ...
                    // Base Static Background Image (Fades out when video is initialized)
                    Positioned.fill(
              ...
              // Vertical list of channels (DirecTV GO style guide)
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isPlaying = channel.id == _previewChannel?.id;
                    return MouseRegion(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isPlaying ? AppColors.primary.withOpacity(0.2) : AppColors.panel,
                          borderRadius: BorderRadius.circular(8),
                          border: Border.all(
