...
class NetflixLayout extends ConsumerStatefulWidget {
  const NetflixLayout({super.key});

  @override
  ConsumerState<NetflixLayout> createState() => _NetflixLayoutState();
}

class _NetflixLayoutState extends ConsumerState<NetflixLayout> {
