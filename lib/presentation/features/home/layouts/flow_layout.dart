...
class FlowLayout extends ConsumerStatefulWidget {
  const FlowLayout({super.key});

  @override
  ConsumerState<FlowLayout> createState() => _FlowLayoutState();
}

class _FlowLayoutState extends ConsumerState<FlowLayout> {
    ...
    return Scaffold(
      ...
      body: channelsAsync.when(
        ...
        data: (channels) {
          ...
          return Row(
            children: [
              // Left Navigation Rail (Flow style)
              Container(
                width: 250,
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.menu_open, color: AppColors.primary, size: 28),
                    ...
                    _buildFlowMenuTile(Icons.home, 'Inicio', true),
                    _buildFlowMenuTile(Icons.live_tv, 'TV en Vivo', false),
                    _buildFlowMenuTile(Icons.movie, 'Películas', false),
                    _buildFlowMenuTile(Icons.tv, 'Series', false),
                    _buildFlowMenuTile(Icons.sports_soccer, 'Deportes', false),
                    const Spacer(),
                    _buildFlowMenuTile(Icons.settings, 'Configuración', false, onTap: () => context.push('/settings')),
                    const SizedBox(height: 24),
                  ],
                ),
              ),
  ...
  Widget _buildFlowMenuTile(IconData icon, String title, bool isSelected, {VoidCallback? onTap}) {
    return InkWell(
      onTap: onTap,
      child: Container(
